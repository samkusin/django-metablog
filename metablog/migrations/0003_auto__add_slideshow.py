...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('metablog_slideshow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('metablog', ['SlideShow'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('metablog_slideshow')
    ...
    models = {
        ...
        'metablog.slideshow': {
            ...
            'slides': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['metablog.Slide']", 'symmetrical': 'False'})
        },
        'metablog.tag': {
