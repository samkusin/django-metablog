...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.atj_word_count'
        db.add_column('metablog_post', 'atj_word_count',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=150),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.atj_word_count'
        db.delete_column('metablog_post', 'atj_word_count')
