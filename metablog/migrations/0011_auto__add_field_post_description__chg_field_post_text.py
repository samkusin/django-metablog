...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('metablog_post', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150),
                      keep_default=False)


        # Changing field 'Post.text'
        db.alter_column('metablog_post', 'text', self.gf('wysihtml5.fields.Wysihtml5TextField')())

    def backwards(self, orm):
        # Deleting field 'Post.description'
        db.delete_column('metablog_post', 'description')


        # Changing field 'Post.text'
        db.alter_column('metablog_post', 'text', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'metablog.post': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '150'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'pings': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            ...
            'search_priority': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            ...
            'text': ('wysihtml5.fields.Wysihtml5TextField', [], {}),
