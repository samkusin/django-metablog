...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.search_priority'
        db.add_column('metablog_post', 'search_priority',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.search_priority'
        db.delete_column('metablog_post', 'search_priority')
